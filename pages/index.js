    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="078S5aIpHRJ6wjiTU1Op9kotfg3CV7v58QBFfWarFTk"
        />
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=AW-11026273781"
        ></script>
        <script
      ...
      <Navbar />
      <Box pt="80px" px={{ xs: 0, lg: 5 }} overflow="hidden">
        <Flex
        ...
        >
          ...
          >
            ...
            <Text
              py={{ xs: 4, lg: 12 }}
              fontSize={{ xs: "14px", lg: "20px", "2xl": "26px" }}
            >
              Há mais de 30 anos entregando o gás da sua casa. Uma das maiores e
              mais reconhecidas revendedoras{" "}
              <Text color="ultragazCyan" as="span">
                ultragaz
              </Text>{" "}
      ...
      <Box py={6} textAlign="center" id="botijões">
        ...
        <Divider
          ...
          mx="auto"
        />
        <Text as="p" fontSize={{ xs: "sm", lg: "md" }} mx="30px">
          A Gasutil oferece dois tipos de botijão ultragaz, referência de gás no
          Brasil a 80 anos.<br></br>
      ...
      <Flex
        bgGradient="linear(to-r, ultragazBlue, ultragazCyan)"
        w="100%"
        h="80px"
        gap={{ xs: "15px", lg: "40px" }}
        align="center"
        ...
        >
          ...
          <Box>
            ...
            <Text as="p" fontSize={{ xs: "base", md: "lg" }}>
              Estamos há mais de 30 anos no mercado de Gás GLP, levando aos
              nossos clientes serviço de confiança, profissionais treinados e
              capacitados com veículos e EPI’s novos, um produto de extrema
              qualidade e com o peso correto. Buscando sempre entregar com
              rapidez, agilidade e segurança. Todo botijão comercializado por
              nós é enmvasado com bases certificadas, sob normas rígidas de
              produção, sempre lacrado e com dicas de utilização e segurança.
            </Text>
          </Box>
        </Box>
      ...
      <Box
        ...
        bgGradient={useColorModeValue(
          "linear(to-t, #EFF0F0 73.94%, rgba(239, 240, 240, 0) 75.84%)",
          "linear(to-t, #000000 73.94%, rgba(0, 0, 0, 0) 75.84%)"
        )}
      >
        <Flex
          w={{ xs: "100%", lg: "950px" }}
        ...
        >
          ...
          >
            ...
            <Text my="15px" fontSize={{ xs: "sm", md: "md" }}>
              Aut reiciendis molestiae et dolores consequatur id maxime laborum
              est sunt tempora et quidem necessitatibus.
            </Text>
            <Link
              style={{ textDecoration: "none" }}
              href="https://www.ultragazenergia.com.br/?utm_medium=001HY000004k0p7YAA"
              target="_blank"
            >
              <Button
                w="150px"
          ...
          >
            ...
            <Box
              ...
              w={{ xs: "100%", md: "100px" }}
              bgGradient={{
                xs: useColorModeValue(
                  "linear(to-t, #FFFFFF, rgba(255, 255, 255, 0))",
                  "linear(to-t, #000000, rgba(255, 255, 255, 0))"
                ),
                md: useColorModeValue(
                  "linear(to-r, #FFFFFF, rgba(255, 255, 255, 0))",
                  "linear(to-r, #000000, rgba(255, 255, 255, 0))"
                ),
              }}
            />
          </Box>
        ...
        >
          ...
          <Image
            src={UltragazSomandoEnergia}
            alt="Ultragaz Somando Energia"
            w="286"
            h="161"
            objectFit="contain"
          />
